...
function PaletteSection({ name, description, swatches, surface }: {
  name:        string;
  description: string;
  ...
  return (
    ...
    >
      <div className="mb-4">
        <p className="text-sm font-semibold font-display" style={{ color: title }}>{name}</p>
...
function PalettePair({ name, description, swatches }: {
  name:        string;
  description: string;
  swatches:    { shade: string; hex: string }[];
}) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <PaletteSection name="Light surface" description={description} swatches={swatches} surface="light" />
        <PaletteSection name="Dark surface"  description={description} swatches={swatches} surface="dark"  />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex gap-2">
        <div className="flex-1 rounded-xl border border-black/5 h-14" style={{ backgroundColor: fg }} />
        <div className="flex-1 rounded-xl border border-black/5 h-14" style={{ backgroundColor: bg }} />
      </div>
      <div>
...
function Legend() {
  ...
  return (
    <div className="rounded-2xl border border-ink-200 dark:border-ink-700 bg-white dark:bg-ink-800 shadow-sm px-5 py-4">
      <p className="text-xs font-semibold font-body text-ink-900 dark:text-ink-50 mb-3">WCAG contrast grades</p>
