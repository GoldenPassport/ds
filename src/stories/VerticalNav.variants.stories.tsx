  ...
  render: () => (
    <div className="min-h-screen flex bg-ink-50 dark:bg-ink-900">
      ...
      <main className="flex-1 p-8 bg-white dark:bg-ink-900">
        <p className="text-sm font-body text-ink-500 dark:text-ink-300">Page content goes here</p>
      </main>
    </div>
  ),
};
    ...
    <div className="flex gap-8 flex-wrap items-start">
      {(['sm', 'md', 'lg'] as const).map((size) => (
        <div key={size} className="flex flex-col gap-2">
          <p className="text-xs font-body text-ink-500 dark:text-ink-300 capitalize">{size}</p>
    ...
    <div className="flex gap-8 flex-wrap items-start">
      {(['none', 'xs', 'sm', 'md'] as const).map((spacing) => (
        <div key={spacing} className="flex flex-col gap-2">
          <p className="text-xs font-body text-ink-500 dark:text-ink-300">{spacing}</p>
    ...
    <div className="flex gap-8 flex-wrap items-start">
      {(['none', 'sm', 'md', 'lg', 'full'] as const).map((radius) => (
        <div key={radius} className="flex flex-col gap-2">
          <p className="text-xs font-body text-ink-500 dark:text-ink-300">{radius}</p>
          <div className="bg-white dark:bg-ink-900 rounded-2xl p-3 w-52">
            <VerticalNav
              radius={radius}
              groups={[{ items: ICON_ITEMS }]}
  ...
  render: () => (
    <div className="flex gap-8 flex-wrap items-start">
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Bordered</p>
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Bordered + shadow sm</p>
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Bordered + shadow md</p>
        <div className="bg-ink-50 dark:bg-ink-900 p-4 w-60">
          <VerticalNav
            bordered
            shadow="md"
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Bordered + shadow lg</p>
        <div className="bg-ink-50 dark:bg-ink-900 p-4 w-60">
          <VerticalNav
            bordered
            shadow="lg"
...
export const AllVariants: Story = {
  ...
  render: () => (
    <div className="flex gap-12 flex-wrap items-start">
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Simple</p>
        <div className="bg-white dark:bg-ink-900 rounded-2xl p-3 w-52">
          <VerticalNav groups={[{ items: SIMPLE_ITEMS }]} aria-label="Simple navigation" />
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">With badges</p>
        <div className="bg-white dark:bg-ink-900 rounded-2xl p-3 w-52">
          <VerticalNav groups={[{ items: BADGE_ITEMS }]} aria-label="Navigation with badges" />
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">With icons</p>
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Icons + badges</p>
        <div className="bg-white dark:bg-ink-900 rounded-2xl p-3 w-64">
          <VerticalNav
      ...
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">Secondary nav</p>
        <div className="bg-white dark:bg-ink-900 rounded-2xl p-3 w-64">
          <VerticalNav groups={SECONDARY_GROUPS} aria-label="Secondary navigation" />
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <p className="text-xs font-body text-ink-500 dark:text-ink-300">On gray</p>
