...
const tokens: Record<SidebarNavAppearance, Tokens> = {
  light: {
    ...
    item:        'font-medium text-ink-600 hover:text-primary-600 hover:bg-primary-50',
    itemActive:  'font-semibold text-primary-600 bg-primary-50',
    ...
    childItem:   'font-medium text-ink-500 hover:text-primary-600 hover:bg-primary-50',
    childActive: 'font-semibold text-primary-600 bg-primary-50',
    chevron:     'text-ink-400',
    childBorder: 'border-ink-200',
    userName:    'text-ink-900',
    userEmail:   'text-ink-500',
    userBtn:     'hover:bg-ink-100',
    dropdownBg:  'bg-white border-ink-200 shadow-md',
    dropdownDivider: 'border-ink-100',
    dropdownItem: 'text-ink-700',
...
export function SidebarNav({
  ...
  return (
    ...
    >
      {/* Logo */}
      {logo && (
        <div className={`shrink-0 flex items-center h-16 px-4 border-b ${t.border}`}>
          {logo}
        </div>
      )}
