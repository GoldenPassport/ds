...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost:
    'bg-transparent text-ink-600 border border-ink-300 hover:bg-ink-50 hover:border-ink-400 dark:text-ink-300 dark:border-ink-600 dark:hover:bg-ink-800 dark:hover:border-ink-500',
  danger:
    'bg-red-100 text-red-700 hover:bg-red-200 border-transparent dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50',
};
