        ...
        header={
          <div className="flex items-center gap-3 px-5 py-3.5">
            <span
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 text-xs font-bold font-display text-ink-900 select-none bg-primary-500"
            >
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline justify-between gap-2">
          ...
          <span className="text-[11px] font-body text-ink-400 dark:text-ink-300 shrink-0">{conv.time}</span>
        </div>
        <div className="flex items-center justify-between gap-2 mt-0.5">
          <span className="text-xs font-body text-ink-400 dark:text-ink-300 truncate">{conv.preview}</span>
          {conv.unread ? (
      ...
      <div className="w-64 shrink-0 flex flex-col border-r border-ink-100 dark:border-ink-800">
        ...
        <div className="px-3 py-2 border-b border-ink-100 dark:border-ink-800">
          <div className="flex items-center gap-2 bg-ink-50 dark:bg-ink-800 rounded-xl px-3 py-1.5">
            <svg className="w-3.5 h-3.5 text-ink-500 dark:text-ink-300 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <circle cx={11} cy={11} r={8} /><path d="m21 21-4.35-4.35" />
            </svg>
            <span className="text-xs font-body text-ink-400 dark:text-ink-300">Search</span>
          </div>
        </div>
          ...
          header={
            <div className="flex items-center gap-3 px-5 py-3.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs font-body text-ink-400 dark:text-ink-300">
