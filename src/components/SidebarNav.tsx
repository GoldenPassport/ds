...
const tokens: Record<SidebarNavAppearance, Tokens> = {
  light: {
    ...
    item:        'font-medium text-ink-600 hover:text-primary-700 hover:bg-ink-100',
    itemActive:  'font-semibold text-primary-700 bg-ink-100',
    ...
    childItem:   'font-medium text-ink-500 hover:text-primary-700 hover:bg-ink-100',
    childActive: 'font-semibold text-primary-700 bg-ink-100',
