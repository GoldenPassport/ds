...
const tokens: Record<SidebarNavAppearance, Tokens> = {
  light: {
    ...
    item:        'font-medium text-ink-600 dark:text-ink-400 hover:text-ink-900 dark:hover:text-ink-50 hover:bg-ink-100 dark:hover:bg-ink-700/40',
    itemActive:  'font-medium text-primary-600 bg-ink-100 dark:bg-ink-700/40',
    icon:        'text-ink-400 group-hover:text-ink-600 dark:group-hover:text-ink-200',
    ...
    childItem:   'font-medium text-ink-500 dark:text-ink-400 hover:text-ink-900 dark:hover:text-ink-50 hover:bg-ink-100 dark:hover:bg-ink-700/40',
    childActive: 'font-medium text-primary-600 bg-ink-100 dark:bg-ink-700/40',
