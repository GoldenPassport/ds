      ...
      {(open, setOpen) => (
        <Drawer {...args} open={open} onClose={() => setOpen(false)}>
          <p className="text-sm font-body text-ink-600 dark:text-ink-300">
            Drawer content goes here. You can put forms, details, lists, or any arbitrary content
            inside.
          </p>
        </Drawer>
      )}
      ...
      {(open, setOpen) => (
        ...
        >
          ...
          <div className="flex flex-col items-center text-center pb-6 mb-6 border-b border-ink-100 dark:border-ink-700">
            ...
            <h2 className="mt-3 text-lg font-bold font-display text-ink-900 dark:text-ink-50">
              Alex Johnson
            </h2>
            ...
            {[
              ...
              <div key={row.label} className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <dd className="text-sm font-medium font-body text-ink-900 dark:text-ink-50">
                    {row.value}
                  </dd>
                </div>
              </div>
            ...
            {[
              ...
              <div key={row.label} className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 min-w-0">
                  <dt className="text-xs font-body text-ink-400 dark:text-ink-300 w-24 shrink-0">
                    {row.label}
                  </dt>
                  <dd className="text-sm font-body text-ink-700 dark:text-ink-300 truncate">
                    {row.value}
                  </dd>
                </div>
              </div>
      ...
      {(open, setOpen) => (
        <>
          <div className="min-h-screen bg-ink-50 dark:bg-ink-900 p-8">
            <h1 className="text-2xl font-bold font-display text-ink-900 dark:text-ink-50">
              Projects
            </h1>
          ...
          >
            <p className="text-sm font-body text-ink-600 dark:text-ink-300">
              Detailed view of the selected item. This pattern is commonly used for item inspection
