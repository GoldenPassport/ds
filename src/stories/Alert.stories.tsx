...
const meta = {
  ...
  argTypes: {
    ...
    actions: {
      control: false,
      description: 'Array of { label, onClick } rendered as text buttons below the body',
    },
...
export const AllVariantsOutline: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-3 max-w-xl">
      <Alert variant="info" appearance="outline" title="Info">
        Your account is pending verification.
      </Alert>
      <Alert variant="success" appearance="outline" title="Success">
        Changes have been saved successfully.
      </Alert>
      <Alert variant="warning" appearance="outline" title="Warning">
        Your subscription expires in 3 days.
      </Alert>
      <Alert variant="error" appearance="outline" title="Error">
        Failed to process payment. Please try again.
      </Alert>
    </div>
  ),
  ...
  render: () => (
    <div className="flex flex-col gap-3 max-w-xl">
      ...
      <Alert
        ...
        actions={[{ label: 'Update billing', onClick: () => alert('Billing') }]}
      >
...
export const NoIcon: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-3 max-w-xl">
      <Alert variant="info" icon={null} title="Scheduled maintenance">
        We'll be down from 02:00–03:00 UTC on Saturday.
      </Alert>
