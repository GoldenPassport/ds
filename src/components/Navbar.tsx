...
const tokens: Record<NavbarAppearance, Tokens> = {
  light: {
    nav:               'bg-white dark:bg-ink-900',
    border:            'border-ink-200 dark:border-ink-700',
    link:              'text-ink-600 dark:text-ink-300 hover:text-ink-900 dark:hover:text-white hover:bg-ink-50 dark:hover:bg-ink-800',
    linkActive:        'text-ink-900 dark:text-white bg-ink-100 dark:bg-ink-800',
    searchWrap:        'bg-ink-50 dark:bg-ink-800 border-ink-200 dark:border-ink-700 focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-500/25',
    ...
    iconBtn:           'text-ink-500 dark:text-ink-400 hover:text-ink-700 dark:hover:text-ink-100 hover:bg-ink-100 dark:hover:bg-ink-800',
    mobileMenu:        'bg-white dark:bg-ink-900 border-t border-ink-200 dark:border-ink-700',
    mobileLink:        'text-ink-600 dark:text-ink-300 hover:text-ink-900 dark:hover:text-white hover:bg-ink-50 dark:hover:bg-ink-800',
    mobileLinkActive:  'text-ink-900 dark:text-white bg-ink-100 dark:bg-ink-800',
    userName:          'text-ink-900 dark:text-white',
    userEmail:         'text-ink-500 dark:text-ink-400',
    userBtn:           'hover:bg-ink-50 dark:hover:bg-ink-800',
