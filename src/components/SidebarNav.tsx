...
const tokens: Record<SidebarNavAppearance, Tokens> = {
  light: {
    ...
    item:        'font-medium text-ink-600 dark:text-ink-400 hover:text-ink-900 dark:hover:text-ink-50 hover:bg-ink-50 dark:hover:bg-ink-700/40',
    ...
    childItem:   'font-medium text-ink-500 dark:text-ink-400 hover:text-ink-900 dark:hover:text-ink-50 hover:bg-ink-50 dark:hover:bg-ink-700/40',
