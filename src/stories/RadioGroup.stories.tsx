...
function Price({ amount, period = '/mo' }: { amount: string; period?: string }) {
  return (
    <span className="flex flex-col items-end">
      ...
      <span className="text-xs text-ink-400 dark:text-ink-500 font-body">{period}</span>
    </span>
  );
}
